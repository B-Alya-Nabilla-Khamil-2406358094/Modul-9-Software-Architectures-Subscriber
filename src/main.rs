...
impl MessageHandler<UserCreatedEventMessage> for UserCreatedHandler {
    ...
    fn handle(&self, message: Box<UserCreatedEventMessage>
        ...
        println!("In Nabilla's Computer [2406358094]. Message received: {:?}", message);
        Ok(())
    }
...
fn main() {
    let listener =
        CrosstownBus::new_queue_listener("amqps://guxllxgh:wCP-oqUPiFfPPAx9VvyHSSPB0lBk4JN2@mustang.rmq.cloudamqp.com/guxllxgh".to_owned()).unwrap();
